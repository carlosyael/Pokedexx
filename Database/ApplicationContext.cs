    ...
    public class ApplicationContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Region>()
                ...
                .HasForeignKey(Pokemon => Pokemon.RegionId).OnDelete(DeleteBehavior.NoAction);
            #endregion
            ...
            modelBuilder.Entity<Tipo>()
                ...
                .HasForeignKey(Pokemon => Pokemon.TipoPriId).OnDelete(DeleteBehavior.NoAction);
            #endregion
            ...
            modelBuilder.Entity<Tipo>()
                ...
                .HasForeignKey(Pokemon => Pokemon.TipoSecId).OnDelete(DeleteBehavior.NoAction);
            #endregion
